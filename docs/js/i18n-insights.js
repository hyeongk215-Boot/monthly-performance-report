...
(function () {
  Object.assign(window.I18N.ko, {
    ...
    insightsHqOnlyNote: "본사 전용 화면입니다. 관리자·본사 회계 접근키로 6개 법인을 모두 조회할 수 있습니다.",
    notEntered: "미입력",
    gaAllEmptyNote: "선택한 법인·기간에 판관비 세부 예산/실적이 입력되지 않았습니다. 예산관리에서 먼저 입력해주세요.",
    gaPartialNote: "일부 항목이 미입력 상태입니다. 미입력은 0원과 구분해 「미입력」으로 표시하며, 판관비 집행률은 예산·실적이 모두 입력된 항목만으로 계산합니다.",
  ...
  Object.assign(window.I18N.zh, {
    ...
    insightsHqOnlyNote: "本页面为总部专用。使用管理员·总部会计接入密钥可查询全部6家法人。",
    notEntered: "未录入",
    gaAllEmptyNote: "所选法人·期间尚未录入管理费用明细预算/实际数，请先在预算管理中录入。",
    gaPartialNote: "部分项目尚未录入。未录入与0元区分显示为「未录入」，管理费用执行率仅按预算和实际均已录入的项目计算。",
