window.I18N = {
  ko: {
    ...
    colTargetProfitCny: "목표영업이익",
    colOverAchievedCny: "초과달성액",
    colAchievementRate: "달성률",
    colHeadcount: "인원수",
    colProductivity: "생산성 (1인당)",
    colCostOfSalesCny: "매출원가",
    colSalesProfitCny: "매출이익",
    colGaExpenseCny: "일반관리비",
    colEntertainmentCny: "접대비",
    colTravelCny: "출장비",
    totalRowLabel: "합계",
    // 홍콩 지점은 HKD, 나머지는 CNY라서 계정 항목마다 (CNY)를 붙이면 홍콩 컬럼과 어긋납니다.
    // 표 전체에 "현지 통화"라고 한 번만 표기합니다.
    unitLocalCurrency: "단위 : LOCAL CURRENCY",
  ...
  zh: {
    ...
    colTargetProfitCny: "目标营业利润",
    colOverAchievedCny: "超额达成额",
    colAchievementRate: "达成率",
    colHeadcount: "人员数",
    colProductivity: "人均生产率",
    colCostOfSalesCny: "销售成本",
    colSalesProfitCny: "销售利润",
    colGaExpenseCny: "一般管理费",
    colEntertainmentCny: "招待费",
    colTravelCny: "差旅费",
    unitLocalCurrency: "单位 : LOCAL CURRENCY",
    totalRowLabel: "合计",
