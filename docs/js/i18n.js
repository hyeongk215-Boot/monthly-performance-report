window.I18N = {
  ko: {
    ...
    targetPerfDesc: "회계관리 PL(한국)·예산관리 목표영업이익/일반관리비 실적을 지점별로 종합합니다. 이번 달(월간) 기준이며, 목표/인원수가 입력되지 않은 지점은 표시되지 않습니다.",
  ...
  zh: {
    ...
    targetPerfDesc: "综合会计管理PL(韩国)与预算管理目标营业利润/一般管理费实际数，按分公司展示。以本月(月度)为准，未填写目标/人员数的分公司不显示。",
